...
| ----- | ---- | ----- | ----------- |
| address_type | [AddressTypeCode](../ivms_enum/#ivms101-AddressTypeCode) |  | Definition: Identifies the nature of the address. |
| department | [string](../scalar/#string) |  | Definition: Identification of a division of a large organisation or building. |
| sub_department | [string](../scalar/#string) |  | Definition: Identification of a sub-division of a large organisation or building. |
| street_name | [string](../scalar/#string) |  | Definition: Name of a street or thoroughfare. |
| building_number | [string](../scalar/#string) |  | Definition: Number that identifies the position of a building on a street. |
| building_name | [string](../scalar/#string) |  | Definition: Name of the building or house. |
| floor | [string](../scalar/#string) |  | Definition: Floor or storey within a building. |
| post_box | [string](../scalar/#string) |  | Definition: Numbered box in a post office, assigned to a person or organisation, where letters are kept until called for. |
| room | [string](../scalar/#string) |  | Definition: Building room number. |
| post_code | [string](../scalar/#string) |  | Definition: Identifier consisting of a group of letters and/or numbers that is added to a postal address to assist the sorting of mail. |
| town_name | [string](../scalar/#string) |  | Definition: Name of a built-up area, with defined boundaries and a local government. |
| town_location_name | [string](../scalar/#string) |  | Definition: Specific location name within the town. |
| district_name | [string](../scalar/#string) |  | Definition: Identifies a subdivision within a country subdivision. |
| country_sub_division | [string](../scalar/#string) |  | Definition: Identifies a subdivision of a country for example, state, region, province, départment or county. |
| address_line | [string](../scalar/#string) | repeated | Definition: Information that locates and identifies a specific address, as defined by postal services, presented in free format text. |
| country | [string](../scalar/#string) |  | Constraint: The value used for the field country must be present on the ISO-3166-1 alpha-2 codes or the value XX. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| date_of_birth | [string](../scalar/#string) |  | Definition: Date on which a person is born. Definition: A point in time, represented as a day within the calendar year. Compliant with ISO 8601. Format: YYYY-MM-DD |
| place_of_birth | [string](../scalar/#string) |  | Definition: The town and/or the city and/or the suburb and/or the country subdivision and/or the country where the person was born. |
...
| customer_number | [string](../scalar/#string) |  | Definition: The unique identification number applied by the VASP to customer. NOTE The specification has a descrepency in that 5.2.9.3.3 specifies an element name as "customerNumber", while the table in 5.2.9.1 calls that element "customerIdentification" |
...
| country_of_registration | [string](../scalar/#string) |  | Definition: The country in which the legal person is registered. Constraint: The value used for the field country must be present on the ISO-3166-1 alpha-2 codes or the value XX. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| legal_person_name | [string](../scalar/#string) |  | Definition: Name by which the legal person is known. |
| legal_person_name_identifier_type | [LegalPersonNameTypeCode](../ivms_enum/#ivms101-LegalPersonNameTypeCode) |  | Definition: The nature of the name specified. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| primary_identifier | [string](../scalar/#string) |  | Definition: This may be the family name, the maiden name or the married name, the main name, the surname, and in some cases, the entire name where the natural person’s name cannot be divided into two parts, or where the sender is unable to divide the natural person’s name into two parts. |
| secondary_identifier | [string](../scalar/#string) |  | Definition: These may be the forenames, familiar names, given names, initials, prefixes, suffixes or Roman numerals (where considered to be legally part of the name) or any other secondary names. |
| name_identifier_type | [NaturalPersonNameTypeCode](../ivms_enum/#ivms101-NaturalPersonNameTypeCode) |  | Definition: The nature of the name specified. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| national_identifier | [string](../scalar/#string) |  | Definition: An identifier issued by an appropriate issuing authority. Constraint: ValidLEI |
| national_identifier_type | [NationalIdentifierTypeCode](../ivms_enum/#ivms101-NationalIdentifierTypeCode) |  | Definition: Specifies the type of identifier specified. |
| country_of_issue | [string](../scalar/#string) |  | Definition: Country of the issuing authority. |
| registration_authority | [string](../scalar/#string) |  | Definition: A code specifying the registration authority. Constraint: The value used for the applicable element must be present on the GLEIF Registration Authorities List. |
